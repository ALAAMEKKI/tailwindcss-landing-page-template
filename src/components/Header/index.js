...
const Header = ({ ...otherProps }) => {
  ...
  return (
    <header className="bg-black opacity-90 relative py-1.5 ">
        ...
        >
          <ul className="md:flex-row md:flex">
            <li className="list-none md:mr-5 ">
              <Link className="flex w-full text-base text-yellow-400 hover:text-yellow-400 cursor-pointer pt-2.5 px-2.5">
                Home
              </Link>
            </li>
            <li className="list-none md:mr-5 ">
